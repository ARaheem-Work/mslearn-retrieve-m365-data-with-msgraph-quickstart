async function displayUI() {    
    ...
    var officeLocation = document.getElementById('officeLocation');
    officeLocation.innerText = user.officeLocation;

    var userPrincipalName = document.getElementById('userPrincipalName');
    userPrincipalName.innerText = user.userPrincipalName;
